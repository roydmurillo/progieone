			  ...
			  foreach($form_data->result() as $r){
					...
					echo "<div class='div_td_content' $class>
					        <div class='f_info' style='min-height:30px !important; width:470px !important'>
					      		<div class='forum_t'><a href='".base_url()."forums/thread/$r->thread_id/".$this->function_forums->clean_url($title)."'>".$title."</a></div>
						   ...
						   echo "<div class='forum_updated'>".$this->function_forums->last_updated_by_thread($r->thread_id,$r->reply_user_id,$r->reply_date)."</div>";
						   echo "</div>
						  </div>";
