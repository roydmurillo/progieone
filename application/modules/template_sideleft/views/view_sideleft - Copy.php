...
<div id="sidebar_left">
  ...
  <form method="POST">	
    ...
    <?php } ?>
	<div id="wish_title">MEMBER LOGIN</div>
    <p> Username </p>
    <p> <input type="text" name="username" /> </p>
    <p> Password </p>
    <p> <input type="password" name="password" /> </p>
    <p> <input type="submit" class="css_btn_c0" style="padding: 0px; width: 140px; margin: 12px 0px 5px 0px;" name="login_submit" value="Login" /> </p>
