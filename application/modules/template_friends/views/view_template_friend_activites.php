<!-- additional scripts -->
<script type="text/javascript" src="<?php echo base_url(); ?>scripts/activites_scripts.js"></script>
...
<?php $this->load->module("function_security"); 
	  $type_initial = $this->function_security->encode("load_friend_activities");
	  $type_invite = $this->function_security->encode("accept_invitation");
...
<input id="type_invite" type="hidden" value="<?php echo $type_invite; ?>">
