   ...
   foreach($results as $r)
    {	
        ...
        echo "<tr class='".$class."'>  
				...
				<td class='tbdata'><div style='float:left; width:100%; height:40px; margin-top:18px; line-height:12px; vertical-align:mmiddle'>".$this->function_brands->get_brand($r->item_brand)."</div></td>
