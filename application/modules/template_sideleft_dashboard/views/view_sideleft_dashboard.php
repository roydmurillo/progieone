...
<div class="sidebar-inner">
  <div >
    <div class="">Welcome <?php echo $this->native_session->get("user_name"); ?>!<br>	</div>
	<div id="avatar">
		<?php 
			if($user_avatar != ""){
	...
	<ul class="nav nav-sidebar">
            <li class="<?php echo ($this->uri->segment(1) == "dashboard" && $this->uri->segment(2) == "" ) ? "active" :""; ?>"><a href="<?php echo base_url() ?>dashboard">Dashboard</a><li>
		<?php 
            ...
            <li class="<?php echo ($this->uri->segment(1) == "dashboard" && $this->uri->segment(2) == "administrator" ) ? "active" :""; ?>"><a href="<?php echo base_url() ?>dashboard/administrator">Admin Dashboard</a></li>
            ...
            <li class="<?php echo ($this->uri->segment(1) == "dashboard" && $this->uri->segment(2) == "sell" ) ? "active" :""; ?>"><a href="<?php echo base_url() ?>dashboard/sell">Sell Items</a></li>
