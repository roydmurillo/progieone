<!-- additional scripts -->
<script type="text/javascript" src="<?php echo base_url(); ?>scripts/inquiry_scripts.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>scripts/pagination.js"></script>

<!-- content goes here -->
<?php $this->load->module("function_security"); 
	  $type_initial = $this->function_security->encode("load_client_inquiries");
		...
		<div id="inner_dashboard">
			...
			<div id="inner_dashboard_tab">
				...
				<a href="<?php echo base_url(); ?>dashboard/inquiry/being_watched">
					<div class="<?php echo ($this->uri->segment(3) == "being_watched") ? "tab_inner_active":"tab_inner checkout"; ?>"> 
						Being Watched
					</div>
				</a>
